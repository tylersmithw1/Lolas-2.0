...
file_path = os.path.join(
    BASE_DIR, "recommendation_products.xlsx"
...
class RecommendationService:
    ...
    def recomendations_by_column(self, product_name, column_name):
        ...
        name_filtered_df = filtered_df[
            filtered_df["name_similarity"] >= 0.025
        ]  # decrease number to increase # of recommendations
        ...
        sorted_result = sorted_result[
            sorted_result["product"].str.lower() != product_name.lower()
        ]
    ...
    TOOLS = [
        get_similar_shelf_products
    ]  # This is how we give the AI agent 'tools' to use
    ...
    def getRecommendationResponse(self, product_name):
        ...
        config = {
            "recursion_limit": self.CHAT_SERVICE.RECURSION_LIMIT,
            "timeout": 20 * 60,
        }
